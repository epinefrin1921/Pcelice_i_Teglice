    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-offset-2 col-md-8 col-sm-12">
                <h2 class="wow fadeInUp" data-wow-delay="0.5s">Uredite proizvod </h2>
                <p class="wow fadeInUp" data-wow-delay="0.8s">
                    Izaberite novu kategoriju proizvoda, prebacite sliku i unesite kolicinu na stanju ili promijenite cijenu
                </p>
            </div>
